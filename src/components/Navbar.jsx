...
export default function Navbar() {
  ...
  return (
    <div className='text-black flex justify-between items-center h-20 max-w-[1240px] mx-auto px-4'>
      ...
      <p className='border hidden md:block border-gray-50 bg-[#ddf7ea] p-1 rounded-md md:ml-6 text-[#00df9a]'>Return&nbsp;10%</p>
        ...
        <ul className='md:flex hidden'>
            ...
            <li onClick={hideNav} className='p-3 ml-2'><Link to="/plan">Plan</Link></li>
        ...
        <div className={!nav ? "fixed left-0 top-20 w-[100%] h-full ease-in-out duration-500 md:hidden" : "fixed -left-[100%]"}>
            ...
            <li onClick={hideNav} className='p-4 hover:text-[#00df9a] border-b border-gray-600 text-center cursor-pointer'><Link to="/plan">Plan</Link></li>
